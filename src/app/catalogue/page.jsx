  ...
  return (
    <section className='min-h-[100vh] w-full flex flex-col items-center  '>
        ...
        <div className='pt-32 pl-10 w-full max-w-[1350px] flex flex-col items-start border-b pb-20'>
          ...
          <p className='w-[70%] text-lg font-semibold text-gray-400'>We not only help you design exceptional products, but also make it easy for you to share your designs with more like-minded people.</p>
