    ...
    <footer className="w-full text-gray-700 bg-gray-100 body-font">
                    ...
                    <span className="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                        ...
                        <Link href={'/'} className="ml-3 text-gray-500 cursor-pointer hover:text-gray-700">
                            <svg fill="currentColor" stroke="currentColor" stroke-linecap="round"
                                stroke-linejoin="round" strokeWidth="0" className="w-5 h-5" viewBox="0 0 24 24">
                                <path stroke="none"
        ...
        <div className="bg-gray-300">
            <div className="container px-5 py-4 mx-auto">
                <p className="text-sm text-gray-700  xl:text-center">Developed by <Link className=' underline' target='_blank' href="https://www.linkedin.com/in/alejo-fernandez-23821b243/">Alejo Fernandez</Link> </p>
            </div>
        </div>
    </footer>
